...
<body>
    <div class="registration-form">
        <form method="post" name="dynamic_field" action="http://localhost/ruleci/Welcome/storePost">
            <table border="5" id="dynamic_field">
                <div class="container">
                    <div id="dynamicCheck">
                        <tr>
                            <td><label><b style="font-family:sans-serif" ;>ADD RULE</b></label></td>
                            <td><input type="text" class="form-control item" id="rules" name="rules[][rule]" style="width:180" required=""></td>
                            <td><label><b style="font-family:sans-serif" ;>ENTER POINT</b></label></td>
                            <td><input type="text" class="form-control item" id="points" name="points[][points]" style="width:180"></td>
                    </div>
                    <td><button type="button" name="add" id="add" class="btn btn-success btn_add" style="font-size:16px;">Add Extra Rule</button></td>
                        </tr>
                </div>
            </table>
            <div id="newElementId"></div>
            <div class="form-group">
                <center><button type="submit" class="btn btn-info create-account">SET RULES</button></center><br>
            </div>
            <div>
  ...
  <!--   <script type="text/JavaScript">
	    ...
	    txtNewInputBox.innerHTML = "  <table border='5'><tr><td><label><b style='font-family:cursive'  ;>SET RULES</b></label></td><td><input type='text' class='form-control item' id='rules' name='rules[][rule]' style='width:180'></td><td><label><b style='font-family:cursive' ;>Enter Points</b></label></td><td><input type='text' class='form-control item' id='points' name='rules[][points]'  style='width:180'></td></div><td><i class='fa fa-plus-circle'style='font-size:40px;' onclick='createNewElement();' aria-hidden='true'></i></td></tr></div>";
